...
save_dir = f'temp/tmp_data/lhq_output/pretrain_task/key_attr/'
...
# dataset
from dataset.title_unequal_2tasks_dataset import FuseReplaceDatasetKeyattr, cls_collate_fn
dataset = FuseReplaceDatasetKeyattr
