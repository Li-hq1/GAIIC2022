...
save_dir = f'temp/tmp_data/lhq_output/pretrain_task/random_replace/'
...
# dataset
from dataset.title_unequal_2tasks_dataset import FuseReplaceDatasetRandommask, cls_collate_fn
dataset = FuseReplaceDatasetRandommask
